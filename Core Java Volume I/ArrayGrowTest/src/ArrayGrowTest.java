...
public class ArrayGrowTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("The following call wil generate an exception");
		b = (String[]) badArrayGrow(b);
	}

	/**
	 * This method attempts to grow an array by allocating a new array and copying all elements
	 * Returns a larger array that contains all elements of a. However, the returned array has type Object[], not the same as type a
	 */
	 ...
	 * Returns a large array that contains all elements of a
	 */
