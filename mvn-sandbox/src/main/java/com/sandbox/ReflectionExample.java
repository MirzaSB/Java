...
public class ReflectionExample {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            Field typePrivateField = rent.getClass().getDeclaredField("type");
            typePrivateField.setAccessible(true);
            typePrivateField.set(rent, "custom_type");
            String fieldValue2 = (String) typePrivateField.get(rent);
